...
public class CeilingUsingBinarySearch {
    public static void main(String[] args) {
        ...
        int result = f2(arr,target);//function call
        System.out.println("ceiling of the target element is "+ arr[result]);
    }
    static int f2(int[] arr, int target){
        ...
        return start_index; // this will only be executed when target does not found in the array
    }
}